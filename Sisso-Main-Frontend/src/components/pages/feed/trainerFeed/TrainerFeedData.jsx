...
import { addBookMarkePost, createConversation } from '../../../../redux/action/trainer.action'
...
const TrainerFeeData = ({ bookMarkedPost }) => {
  ...
  }, [PostTrainingData, bookMarkedPost, dispatch]);
  ...
  const [showAllComments, setShowAllComments] = useState(new Array(PostTrainingData?.length).fill(false));
  ...
  const handleAddComment = async (e) => {
    ...
    if (addNewComment !== '') {
      const comment = {
        ...
        commentedByProfile: trainer?.basicInfo?.profileImg,
        commentedByName: trainer?.fullName,
        commentedByCompany: trainer?.basicInfo?.company,
                    ...
                    <div className='centered-section2'>
                          ...
                          <div style={{ position: 'relative', display: 'inline-block' }}>
                            ...
                            {open2[index] && (
                              ...
                              >
                                ...
                                <div onClick={() => handleIconClick3(post._id, currentUserId)} className='option' style={{ padding: '5px', cursor: 'pointer', fontSize: '12px' }}>Not Intrested!</div>
                              </div>
                            )}
                          </div>
                        </div>
                      ...
                      <p
                        ...
                        <div className='skilldata2'>
                          ...
                          <h5><span className='skillchild font-[600]' >Budget -</span> <span className='skillchild2'>₹ {post.minBudget} - ₹ {post.maxBudget} /<span className='text-sm'>{post?.durationType}</span> </span> </h5>
                          {
                            ...
                            <div className='skillfooter2'>
                              <div onClick={() => handleIconClick2(post._id, currentUserId)} >
                                {likedPosts.includes(currentUserId) && post.likes.some(like => like._id === currentUserId) ?
                                  (
                                    <svg className='comments' xmlns="http://www.w3.org/2000/svg" width="20" height="18" viewBox="0 0 20 18" fill="none" style={{ cursor: 'pointer' }}>
                                    ...
                                    <div>
                                      ...
                                      <svg className='like ' xmlns="http://www.w3.org/2000/svg" width="20" height="18" viewBox="0 0 20 18" fill="#2676c3" style={{ cursor: 'pointer' }}>
                        ...
                        <section>
                          ...
                          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between' }}>
                            ...
                            <div className='skillFooter'>
                              <p style={{ color: '#2676C2', fontWeight: '400px', margin: '0px' }}> ₹ {post?.minBudget} - ₹ {post.maxBudget}/ <span className='text-sm'>{post?.durationType}</span></p>
                                ...
                                {post?.comments?.slice(-numCommentsToShow).map((item, index) => (
                                  <div key={index} style={{ display: 'flex', margin: '5px', marginTop: '10px' }}>
                                    ...
                                    <div style={{ maxWidth: "436px", backgroundColor: '#f0f0f0', padding: '10px', marginLeft: '10px', borderStartEndRadius: '15px', borderEndStartRadius: '15px', borderEndEndRadius: '15px', border: '2px solid #E9E9E9' }}>
                                      ...
                                      <div>
                                        <p style={{ color: '#888888', fontSize: '14px' }}>{item?.comment}</p>
                                      </div>
                                    </div>
                                  </div>
                                ))}
