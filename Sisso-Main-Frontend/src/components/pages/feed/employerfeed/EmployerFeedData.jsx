...
import { addBookMarkePost } from "../../../../redux/action/employers.action";
...
const EmployerFeedData = ({ bookMarkedPost, setPopUpButton2 }) => {
  ...
  console.log('secletdpost', selectedPost?._id)
